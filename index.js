...
var DB = {
  productos:[
    {nombre:'Cable FO Corning SMF-28 Ultra OS2',sku:'COR-SMF28-001',proveedor:'Corning Inc.',categoria:'Cable Monomodo',cantidad:120,costo:280,precio:420,desc:'Cable monomodo 9/125µm, baja pérdida',minstock:20,fibraColor:'Azul',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Cable FO Corning InfiniCor 300 OM3',sku:'COR-OM3-002',proveedor:'Corning Inc.',categoria:'Cable Multimodo',cantidad:85,costo:190,precio:300,desc:'Multimodo 50/125µm OM3, color aqua',minstock:15,fibraColor:'Aqua',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Cable FO Corning InfiniCor 550 OM4',sku:'COR-OM4-003',proveedor:'Corning Inc.',categoria:'Cable Multimodo',cantidad:60,costo:240,precio:380,desc:'Multimodo 50/125µm OM4, color violeta',minstock:10,fibraColor:'Violeta',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Cable FO Corning ClearCurve OM5',sku:'COR-OM5-004',proveedor:'Corning Inc.',categoria:'Cable Multimodo',cantidad:40,costo:320,precio:500,desc:'Multimodo OM5 verde lima, wideband',minstock:8,fibraColor:'Verde',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Conector SC/APC Corning HFC',sku:'COR-SCAPC-005',proveedor:'Corning Inc.',categoria:'Conectores',cantidad:500,costo:28,precio:55,desc:'Conector SC/APC verde, pérdida ≤0.3dB',minstock:50,fibraColor:'Verde',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Ninguno',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Conector LC/UPC Corning Unicam',sku:'COR-LCUPC-006',proveedor:'Corning Inc.',categoria:'Conectores',cantidad:400,costo:22,precio:42,desc:'Conector LC/UPC azul, campo instalable',minstock:50,fibraColor:'Azul',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Ninguno',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Empalme por Fusión Corning LST',sku:'COR-EMP-007',proveedor:'Corning Inc.',categoria:'Empalmes',cantidad:200,costo:15,precio:32,desc:'Manga termocontráctil 60mm para empalme',minstock:30,fibraColor:'Naranja',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Patch Cord SC-SC OS2 3m',sku:'COR-PC-SCSC-008',proveedor:'Corning Inc.',categoria:'Patch Cord',cantidad:75,costo:95,precio:160,desc:'Jumper SC/UPC-SC/UPC OS2 amarillo 3m',minstock:10,fibraColor:'Amarillo',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Patch Cord LC-LC OM3 2m',sku:'COR-PC-LCLC-009',proveedor:'Corning Inc.',categoria:'Patch Cord',cantidad:90,costo:80,precio:140,desc:'Jumper LC/UPC-LC/UPC OM3 aqua 2m',minstock:10,fibraColor:'Aqua',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Bandeja de Empalme Corning CCH',sku:'COR-BAN-010',proveedor:'Corning Inc.',categoria:'Infraestructura',cantidad:30,costo:450,precio:720,desc:'Bandeja 12 empalmes, rack 1U',minstock:5,fibraColor:'Gris',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Ninguno',fibraColorante:'Masterbatch amarillo'},
    {nombre:'ODF Rack 24 puertos SC Corning',sku:'COR-ODF-011',proveedor:'Corning Inc.',categoria:'Infraestructura',cantidad:18,costo:1200,precio:1900,desc:'Distribuidor de fibra óptica 24p SC, 1U',minstock:3,fibraColor:'Negro',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Ninguno',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Óptica Corning SMF-28e+ Bobina 1km',sku:'COR-BOB-012',proveedor:'Corning Inc.',categoria:'Bobinas',cantidad:25,costo:1800,precio:2800,desc:'Bobina 1000m SMF-28e+, OS2, amarillo',minstock:3,fibraColor:'Amarillo',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Óptica Corning OM3 Bobina 1km',sku:'COR-BOB-013',proveedor:'Corning Inc.',categoria:'Bobinas',cantidad:20,costo:2200,precio:3400,desc:'Bobina 1000m OM3 50/125µm, aqua',minstock:3,fibraColor:'Aqua',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Gel de Relleno Corning para Cable',sku:'COR-GEL-014',proveedor:'Corning Inc.',categoria:'Accesorios',cantidad:150,costo:85,precio:140,desc:'Gel protector para cables con holgura',minstock:20,fibraColor:'',fibraMarca:'',fibraMaterial:'',fibraHilo:'',fibraColorante:''},
    {nombre:'Cable Drop ADSS Corning 24FO',sku:'COR-ADSS-015',proveedor:'Corning Inc.',categoria:'Cable Aéreo',cantidad:45,costo:3500,precio:5200,desc:'Cable aéreo ADSS 24 fibras, autosoportado',minstock:5,fibraColor:'Negro',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Azul #1 Sólido PBT',sku:'FIB-AZ-001',proveedor:'Corning Inc.',categoria:'Fibra Suelta',cantidad:200,costo:12,precio:22,desc:'Fibra #1 azul, holgura PBT',minstock:30,fibraColor:'Azul',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Naranja #2 Sólido PBT',sku:'FIB-NA-002',proveedor:'Corning Inc.',categoria:'Fibra Suelta',cantidad:200,costo:12,precio:22,desc:'Fibra #2 naranja, holgura PBT',minstock:30,fibraColor:'Naranja',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Verde #3 Sólido PBT',sku:'FIB-VE-003',proveedor:'Corning Inc.',categoria:'Fibra Suelta',cantidad:200,costo:12,precio:22,desc:'Fibra #3 verde, holgura PBT',minstock:30,fibraColor:'Verde',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Café #4 Sólido PBT',sku:'FIB-CA-004',proveedor:'Corning Inc.',categoria:'Fibra Suelta',cantidad:200,costo:12,precio:22,desc:'Fibra #4 café, holgura PBT',minstock:30,fibraColor:'Café',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
    {nombre:'Fibra Gris #5 Sólido PBT',sku:'FIB-GR-005',proveedor:'Corning Inc.',categoria:'Fibra Suelta',cantidad:200,costo:12,precio:22,desc:'Fibra #5 gris, holgura PBT',minstock:30,fibraColor:'Gris',fibraMarca:'Sólido',fibraMaterial:'PBT',fibraHilo:'Aramida (Kevlar)',fibraColorante:'Masterbatch amarillo'},
  ],
  proveedores:[
    {nombre:'Corning Inc.',contacto:'Distribuidor Oficial',tel:'8001234567',email:'ventas@corning.com',dir:'1 Riverfront Plaza, Corning, NY',notas:'Proveedor principal de fibra óptica',rfc:'COR800101AB1',curp:'',nss:''},
    {nombre:'Corning Cable México',contacto:'Gerente de Ventas',tel:'5551234567',email:'mexico@corning.com',dir:'Av. Insurgentes Sur 1234, CDMX',notas:'Distribuidor autorizado México',rfc:'CCM900215BC2',curp:'',nss:''},
  ],
  ventas:[],
  mermas:[],
  empleados:[
    {nombre:'Juan Pérez',puesto:'Cajero',tel:'8181111111',email:'juan@mipos.com',notas:'Turno matutino',idcolab:'EMP-001',curp:'PEJX900101HNTRZN00',nss:'12345678901',rfc:'PEJX900101ABC',dir:'Calle Reforma 123, Col. Centro',foto:''},
    {nombre:'María García',puesto:'Cajera',tel:'8182222222',email:'maria@mipos.com',notas:'Turno vespertino',idcolab:'EMP-002',curp:'GAMY950215MNTRCR05',nss:'98765432109',rfc:'GAMY950215XYZ',dir:'Av. Juárez 456, Col. Norte',foto:''},
  ],
};
var empDetalleIdx=-1;
...
function guardarLocal(){
  try{localStorage.setItem('mipos_db',JSON.stringify(DB));localStorage.setItem('mipos_vc',ventaCounter);}catch(e){}
}
function cargarLocal(){
  try{
    var d=localStorage.getItem('mipos_db');
    if(d){DB=JSON.parse(d);}
    var vc=localStorage.getItem('mipos_vc');
    if(vc)ventaCounter=parseInt(vc);
  }catch(e){}
}
cargarLocal();
 
// Migración: asegurar campos nuevos en datos existentes
DB.empleados.forEach(function(e){
  if(!e.idcolab)e.idcolab='';
  if(!e.curp)e.curp='';
  if(!e.nss)e.nss='';
  if(!e.rfc)e.rfc='';
  if(!e.dir)e.dir='';
...
DB.mermas.forEach(function(m){
  if(!m.culpable)m.culpable='';
});
...
function pintarInv(){
  ...
  tb.innerHTML=prods.map(function(p){
    ...
    // *** CAMBIO: "Stock Completo" en lugar de "OK" ***
...
function abrirNuevoProducto(){
  ...
  ['mp-nombre','mp-sku','mp-cat','mp-desc'].forEach(function(id){$$(id).value='';});
  ...
  var sel=$$('mp-prov');
  sel.innerHTML='<option value="Sin proveedor">Sin proveedor</option>'+DB.proveedores.map(function(p){return '<option>'+p.nombre+'</option>';}).join('');
  abrirMod('mp');
}
...
function editProducto(ri){
  ...
  var sel=$$('mp-prov');
  sel.innerHTML='<option value="Sin proveedor">Sin proveedor</option>'+DB.proveedores.map(function(v){return '<option>'+v.nombre+'</option>';}).join('');
  sel.value=p.proveedor;calcMargen();abrirMod('mp');
}
 
function guardarProducto(){
  var nombre=$$('mp-nombre').value.trim();
  if(!nombre){toast('El nombre es obligatorio','error');return;}
  var obj={nombre:nombre,sku:$$('mp-sku').value.trim(),proveedor:$$('mp-prov').value,categoria:$$('mp-cat').value.trim(),cantidad:parseInt($$('mp-qty').value)||0,costo:parseFloat($$('mp-costo').value)||0,precio:parseFloat($$('mp-precio').value)||0,desc:$$('mp-desc').value.trim(),minstock:parseInt($$('mp-minstock').value)||5,fibraColor:$$('mp-fibra-color').value,fibraMarca:$$('mp-fibra-marca').value,fibraMaterial:$$('mp-fibra-material').value,fibraHilo:$$('mp-fibra-hilo').value,fibraColorante:$$('mp-fibra-colorante').value};
  ...
  cerrarModal('mp');guardarLocal();pintarInv();
}
 
function eliminarProducto(ri){
  if(!confirm('¿Eliminar "'+DB.productos[ri].nombre+'"?'))return;
  DB.productos.splice(ri,1);guardarLocal();pintarInv();toast('Producto eliminado','info');
}
...
function guardarProveedor(){
  ...
  if(!nombre){toast('El nombre es obligatorio','error');return;}
  var obj={nombre:nombre,contacto:$$('mpv-contacto').value.trim(),tel:$$('mpv-tel').value.trim(),email:$$('mpv-email').value.trim(),dir:$$('mpv-dir').value.trim(),notas:$$('mpv-notas').value.trim(),rfc:$$('mpv-rfc').value.trim(),curp:$$('mpv-curp').value.trim(),nss:$$('mpv-nss').value.trim()};
  ...
  cerrarModal('mpv');guardarLocal();pintarProv();
}
 
function eliminarProveedor(i){
  if(!confirm('¿Eliminar "'+DB.proveedores[i].nombre+'"?'))return;
  DB.proveedores.splice(i,1);guardarLocal();pintarProv();toast('Proveedor eliminado','info');
}
...
function hacerVenta(){
  ...
  guardarLocal();cerrarModal('mv');pintarInv();pintarVtas();
...
// ==================== MERMAS (MULTI-PRODUCTO) ====================
var mmLista=[];
 
function abrirNuevaMerma(){
  mmLista=[];
  // Rellenar datalist de culpables con empleados
...
function guardarEmpleado(){
  ...
  cerrarModal('me');guardarLocal();pintarEmp();
}
...
function eliminarEmpDesdeDetalle(){
  ...
  DB.empleados.splice(empDetalleIdx,1);cerrarModal('med');guardarLocal();pintarEmp();toast('Empleado eliminado','info');
}
